...
export function video(...args: Array<AttributeMap | ChildArg | HtmlTagOptions>): PairType { return makePairTag(TAG_TYPES.video, args); }

/** Creates an `<audio>` element (audio player). */
export function audio(...args: Array<AttributeMap | ChildArg | HtmlTagOptions>): PairType { return makePairTag(TAG_TYPES.audio, args); }

/** Creates a `<picture>` element (responsive image container). */
export function picture(...args: Array<AttributeMap | ChildArg | HtmlTagOptions>): PairType { return makePairTag(TAG_TYPES.picture, args); }

/** Creates a `<canvas>` element (scriptable graphics). */
export function canvas(...args: Array<AttributeMap | ChildArg | HtmlTagOptions>): PairType { return makePairTag(TAG_TYPES.canvas, args); }

/** Creates an `<svg>` element (scalable vector graphics). */
export function svg(...args: Array<AttributeMap | ChildArg | HtmlTagOptions>): PairType { return makePairTag(TAG_TYPES.svg, args); }
 ...
 * ```
 */
export function br(options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.br, undefined, options); }
 ...
 * ```
 */
export function hr(options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.hr, undefined, options); }
 ...
 * ```
 */
export function img(attrs?: AttributeMap, options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.img, attrs, options); }
 ...
 * ```
 */
export function input(attrs?: AttributeMap, options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.input, attrs, options); }
 ...
 * ```
 */
export function meta(attrs?: AttributeMap, options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.meta, attrs, options); }
 ...
 * ```
 */
export function link(attrs?: AttributeMap, options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.link, attrs, options); }
 ...
 * ```
 */
export function source(attrs?: AttributeMap, options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.source, attrs, options); }
 ...
 * ```
 */
export function track(attrs?: AttributeMap, options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.track, attrs, options); }
 ...
 */
export function area(attrs?: AttributeMap, options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.area, attrs, options); }
 ...
 */
export function col(attrs?: AttributeMap, options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.col, attrs, options); }
 ...
 * ```
 */
export function base(attrs?: AttributeMap, options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.base, attrs, options); }
 ...
 */
export function embed(attrs?: AttributeMap, options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.embed, attrs, options); }
 ...
 * ```
 */
export function wbr(options?: HtmlTagOptions): SelfClosingType { return makeSelfClosingTag(TAG_TYPES.wbr, undefined, options); }
