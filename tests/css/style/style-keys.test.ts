...
describe('CSSPropertyKey', () => {
  ...
  // ============================================================
  describe('カテゴリ件数合計', () => {
    it('13カテゴリの合計が148になり、実際のキー数と一致する', () => {
      // Font:7 + Background:6 + Spacing:10 + Border:20 + Flex:12 +
      // Grid:14 + Visual:6 + Text:13 + Transform:6 + Animation:14 +
      // Table:5 + List:4 + Visibility:31 = 148
      const expectedTotal = 7 + 6 + 10 + 20 + 12 + 14 + 6 + 13 + 6 + 14 + 5 + 4 + 31;
      expect(expectedTotal).toBe(148);
